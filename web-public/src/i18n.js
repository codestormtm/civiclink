...
const translations = {
  en: {
    ...
    "wizard.kicker": "Citizen report wizard",
    "wizard.title": "Report a problem",
    "wizard.aiShortcut": "AI Help",
    "wizard.loading": "Preparing your secure report session...",
    "wizard.start": "Start Report",
    "wizard.continue": "Continue",
    "wizard.routing": "Preparing the right route...",
    "wizard.welcome.title": "Tell us what happened",
    "wizard.welcome.copy": "You do not need to choose a government department. Describe the issue, add proof, pick the location, and CivicLink will route it.",
    "wizard.describe.title": "Describe the problem",
    "wizard.describe.copy": "Write one clear description. Include what happened, what is affected, and anything urgent.",
    "wizard.describe.placeholder": "Example: A street light is broken near the bus stop and the road is dark at night.",
    "wizard.emergency.title": "Emergency warning",
    "wizard.emergency.copy": "CivicLink is for civic service reports. If someone is in immediate danger, contact emergency services first before submitting this report.",
    "wizard.emergency.ack": "I understand this is not an emergency response channel.",
    "wizard.photo.title": "Add a photo",
    "wizard.photo.copy": "A photo helps the field team verify the issue faster. You can skip this if you do not have one.",
    "wizard.photo.choose": "Choose photo",
    "wizard.photo.replace": "Replace photo",
    "wizard.photo.skip": "Skip Photo",
    "wizard.photo.previewAlt": "Selected report evidence",
    "wizard.location.title": "Pick the location",
    "wizard.location.copy": "Use GPS or drop a pin where the issue happened. This helps the assigned team find it quickly.",
    "wizard.review.title": "Review your report",
    "wizard.review.copy": "CivicLink has prepared the report and selected the routing behind the scenes.",
    "wizard.review.photo": "Photo",
    "wizard.review.noPhoto": "No photo added",
    "wizard.review.notReady": "The report still needs a clearer description or routing result. Go back and add more detail, then try again.",
    "wizard.success.title": "Report submitted",
    "wizard.success.copy": "Your report has been routed to the relevant department. Keep the tracking ID for updates.",
    "wizard.warning.photo": "Your report was submitted, but the photo could not be uploaded. Keep the tracking ID and add a new report if the photo is essential.",
    "wizard.error.unavailable": "AI routing is not available right now. Please try again shortly.",
    "wizard.error.description": "Describe the issue in at least 10 characters.",
    "wizard.error.route": "CivicLink could not prepare the route. Add a little more detail and try again.",
    "wizard.error.incomplete": "The report is not ready to submit yet.",
    "wizard.error.submit": "Failed to submit the report.",
    ...
    "track.pastComplaints": "Past complaints",
    "track.untitledPast": "Complaint report",
    "track.statusUnknown": "Status unknown",
    "track.removePast": "Remove from past complaints",
